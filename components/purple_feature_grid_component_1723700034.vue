  ...
  <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
    ...
    <div id="feature-1">
      <div id="feature-1-header" class="flex items-center space-x-2 mb-1">
        <svg id="feature-1-icon" class="shrink-0" xmlns="http://www.w3.org/2000/svg"
          width="16"
          height="16"
        >
        ...
        <div class="flex" id="feature-1-title-container">
          <h4
            ...
            :class="textSecondaryStyle"
          >
            Extensive Racket Selection
          </h4>
        </div>
      </div>
    ...
    <div id="feature-2">
      <div id="feature-2-header" class="flex items-center space-x-2 mb-1">
        <svg id="feature-2-icon" class="shrink-0" xmlns="http://www.w3.org/2000/svg"
          width="16"
          height="16"
        >
    ...
    <div id="feature-3">
      <div id="feature-3-header" class="flex items-center space-x-2 mb-1">
        <svg id="feature-3-icon" class="shrink-0" xmlns="http://www.w3.org/2000/svg"
          width="16"
          height="16"
        >
      ...
      <div class="flex" id="feature-3-description-container">
        <p id="feature-3-description" class="flex-1 text-sm" :class="textPrimaryStyle">
          Access comprehensive information on each racket, including weight, balance, string pattern, and grip size, to make informed decisions.
        </p>
      </div>
    </div>
    <!-- Feature 4 -->
    <div id="feature-4">
      <div id="feature-4-header" class="flex items-center space-x-2 mb-1">
        <svg id="feature-4-icon" class="shrink-0" xmlns="http://www.w3.org/2000/svg"
          width="16"
          height="16"
        >
      ...
      <div class="flex" id="feature-4-description-container">
        <p id="feature-4-description" class="flex-1 text-sm" :class="textPrimaryStyle">
          Read authentic feedback from fellow tennis enthusiasts to gain insights into real-world performance of different rackets.
        </p>
      </div>
    </div>
    <!-- Feature 5 -->
    <div id="feature-5">
      <div id="feature-5-header" class="flex items-center space-x-2 mb-1">
        <svg id="feature-5-icon" class="shrink-0" xmlns="http://www.w3.org/2000/svg"
          width="16"
          height="16"
        >
      ...
      <div class="flex" id="feature-5-description-container">
        <p id="feature-5-description" class="flex-1 text-sm" :class="textPrimaryStyle">
          Compare prices across multiple sellers to ensure you get the best deal on your chosen tennis racket.
        </p>
      </div>
    </div>
    <!-- Feature 6 -->
    <div id="feature-6">
      <div id="feature-6-header" class="flex items-center space-x-2 mb-1">
        <svg id="feature-6-icon" class="shrink-0" xmlns="http://www.w3.org/2000/svg"
          width="16"
          height="16"
        >
      ...
      <div class="flex" id="feature-6-description-container">
        <p id="feature-6-description" class="flex-1 text-sm" :class="textPrimaryStyle">
          Shop with confidence using our encrypted payment system and trusted seller verification process.
        </p>
      </div>
    </div>
